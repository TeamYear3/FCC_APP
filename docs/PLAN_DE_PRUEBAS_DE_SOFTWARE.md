...
#### C. Catálogo Detallado de Casos de Prueba Automatizados Backend

A continuación se documentan los casos de prueba concretos implementados en la suite automatizada del backend:
