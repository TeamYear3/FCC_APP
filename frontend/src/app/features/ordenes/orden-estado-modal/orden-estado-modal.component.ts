    ...
    @if (mostrar) {
      ...
      >
        ...
        >
            ...
            <div class="flex items-center gap-3">
              ...
              <div>
                ...
                <p class="text-xs text-gray-400">
                  OT: <span class="text-[#FFCC00] font-mono font-bold">{{ orden?.numero_ot }}</span>
                </p>
              </div>
            </div>
            <button
          ...
          @if (mensajeExito()) {
            <div
              class="text-xs font-bold text-emerald-400 bg-emerald-950/40 border border-emerald-500/40 p-3 rounded-xl"
            >
              {{ mensajeExito() }}
            </div>
          }
          @if (mensajeError()) {
            <div
              class="text-xs font-bold text-red-400 bg-red-950/40 border border-red-500/40 p-3 rounded-xl"
            >
              {{ mensajeError() }}
            </div>
          }
